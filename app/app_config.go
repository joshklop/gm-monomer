...
import (
	...
	consensustypes "github.com/joshklop/monomer-cosmos-sdk/x/consensus/types"
	...
	gmmonomermodulev1 "github.com/joshklop/gm-monomer/api/gmmonomer/gmmonomer/module"
	_ "github.com/joshklop/gm-monomer/x/gmmonomer/module" // import for side-effects
	gmmonomermoduletypes "github.com/joshklop/gm-monomer/x/gmmonomer/types"
...
var (
	...
	genesisModuleOrder = []string{
		...
		circuittypes.ModuleName,
		// chain modules
		gmmonomermoduletypes.ModuleName,
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			{
				Name:   gmmonomermoduletypes.ModuleName,
				Config: appconfig.WrapAny(&gmmonomermodulev1.Module{}),
			},
